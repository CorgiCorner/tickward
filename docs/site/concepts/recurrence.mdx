...
Recurring timers do not enter [Started counting up](/concepts/started-counting-up)
and do not create count-up review occurrences. That review flow is reserved for
one-off timers whose counter continues upward after zero.
