...
- Keep one-off timers visible for review after zero with [Started counting up](/concepts/started-counting-up); repeating timers continue to their next occurrence.
