...
Webhook delivery is asynchronous. Create webhook endpoints in Settings, then run
the scheduler tick endpoint from Cloudflare Cron, EventBridge, a VPS cron job,
or another scheduler. See [Webhooks and scheduler](/guides/webhooks).
